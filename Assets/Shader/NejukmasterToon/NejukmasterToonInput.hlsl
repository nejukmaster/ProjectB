...
//StylizedLit
float4 _MedColor, _ShadowColor, _ReflectColor, _OutlineColor;
...
float _OutlineThreshold, _OutlineSmooth;
float _GIIntensity, _GIThreshold, _GISmooth;
float _ReceiveShadows;
float _GGXSpecular, _DirectionalFresnel;
CBUFFER_END
